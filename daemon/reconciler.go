...
func (dr *DealReconciler) reconcileImportedDeals() {
	...
	boost, err := svc.NewBoostConnection(dr.cfg.BoostAddress, dr.cfg.BoostPort, dr.cfg.BoostGqlPort, dr.cfg.BoostAPIKey, dr.cfg.StagingDir, dr.cfg.DeleteAfterImport)
	if err != nil {
