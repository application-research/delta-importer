module github.com/application-research/delta-importer
...
require (
	...
	github.com/filecoin-project/boost-gfm v1.26.5 // indirect
	...
	github.com/filecoin-project/lotus v1.23.0-rc1 // indirect
